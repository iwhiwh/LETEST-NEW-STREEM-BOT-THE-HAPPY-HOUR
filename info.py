...
BOT_TOKEN = environ.get('BOT_TOKEN', "6624330389:AAF2SF3vWP4VztPPdZAF8o6yQIOov8QlnpY")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1991522624').split()]
